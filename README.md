...
- Horario de atención
- Color de marca
- Plantillas de mensajes WhatsApp y Email
- Módulo de Email (Activación SMTP/API Key)
- Términos y Condiciones Legales (Tickets)
...
- 💬 **Integración mejorada con WhatsApp y plantillas**
- 📧 **Configuración nativa de Emails transaccionales**
- 🎨 **Diseño premium de Modo Claro bloqueado**
- ⚖️ **Adición de Términos Legales y Checklist de Accesorios**
