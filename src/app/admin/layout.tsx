...
export default function AdminLayout({
            ...
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 group relative ${
                active
                  ...
                  : "text-slate-400 hover:text-white hover:bg-slate-700/50 active:bg-slate-700"
              }`}
            >
  ...
  return (
    <div className="min-h-screen bg-gray-50/80 dark:bg-gray-900 transition-colors">
      {/* Desktop Sidebar */}
      <aside
      ...
      >
        ...
        <button
          ...
          className="absolute -right-3 top-20 bg-slate-700 hover:bg-slate-600 active:bg-slate-500 text-slate-300 rounded-full p-1 shadow-lg transition-colors border border-slate-600"
        >
      ...
      {/* Mobile Top Bar */}
      <nav className="lg:hidden bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-40 transition-colors">
        <div className="flex justify-between items-center h-14 px-4">
          <div className="flex items-center gap-3">
            <button
              onClick={() => setMobileSidebarOpen(true)}
              aria-label="Abrir menú de navegación"
              className="p-1.5 -ml-1.5 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 active:bg-gray-200 dark:active:bg-gray-600 rounded-lg transition-colors"
            >
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-gray-900 dark:text-white text-sm">{businessName || "Mi Taller"}</span>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <NotificationsDropdown />
            <Link href="/" aria-label="Ver sitio público" className="text-xs text-gray-400 dark:text-gray-500 hover:text-primary-600 dark:hover:text-primary-400 p-1.5 rounded-lg">
        ...
        <>
          ...
          <aside className="lg:hidden fixed top-0 left-0 h-screen w-72 bg-slate-800 z-50 shadow-2xl sidebar-slide-in">
            ...
            <button
              ...
              className="absolute top-4 right-3 text-slate-400 hover:text-white p-1.5 rounded-lg hover:bg-slate-700/50 active:bg-slate-700"
            >
              <X className="h-5 w-5" />
            </button>
          </aside>
      ...
      {/* Bottom Nav - Mobile */}
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white/95 dark:bg-gray-800/95 backdrop-blur-lg border-t border-gray-200 dark:border-gray-700 z-40 safe-area-bottom transition-colors">
