...
export function SignaturePad({ onSave, initialValue, disabled }: SignaturePadProps) {
  ...
  return (
    <div>
      ...
      <canvas
        ref={canvasRef}
        className={`w-full h-32 border-2 border-dashed rounded-lg cursor-crosshair touch-none ${disabled ? "border-gray-200 bg-gray-50 dark:bg-gray-900/50" : "border-gray-300 bg-white dark:bg-gray-800 hover:border-primary-400"
          }`}
