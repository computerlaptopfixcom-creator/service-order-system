...
export function PaymentSummary({ totalCost, totalPaid, balanceDue, paymentStatus }: PaymentSummaryProps) {
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 p-4 shadow-sm space-y-3">
            ...
            <div className="space-y-1 pt-2 border-t border-gray-100">
                <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-gray-900 dark:text-white">{formatMoney(totalCost, currency)}</span>
                </div>
                <div className="flex justify-between text-sm">
